    ...
    public static void loadTradeAccounts() throws IOException {
        ...
        .forEach(line -> {
            ...
            if(words[0].equals(TradeAccountType.CASH.toString())){
                cashAccountService.createTradeAccount(new CashAccount(words[1], BigDecimal.valueOf(Double.valueOf(words[2]))));
            }else if(words[0].equals(TradeAccountType.MARGIN.toString())){
                marginAccountService.createTradeAccount(new MarginAccount(words[1], BigDecimal.valueOf(Double.valueOf(words[2]))));
            }
        });
    }
        ...
        .forEach(line -> {
            ...
            if(words[0].equals(TradeAccountType.CASH.toString())){
                if (words[2].equals(Transaction.DEPOSIT.toString())){
                    cashAccountService.deposit(words[1], BigDecimal.valueOf(Double.parseDouble(words[3])));
                }else{
                    cashAccountService.withdraw(words[1], BigDecimal.valueOf(Double.parseDouble(words[3])));
                }
            }else if(words[0].equals(TradeAccountType.MARGIN.toString())){
                if (words[2].equals(Transaction.DEPOSIT.toString())){
                    marginAccountService.deposit(words[1], BigDecimal.valueOf(Double.parseDouble(words[3])));
                }else{
                    marginAccountService.withdraw(words[1], BigDecimal.valueOf(Double.parseDouble(words[3])));
                }
            }
        });
    }
